...
function handleCarousel(){
    var aLi = document.querySelectorAll('.header-ad .LunBo-img');
    var aBtn = document.querySelectorAll('.header-ad .ad-btn .btn-ul li');
    var oCarousel = document.querySelector('.header-ad');
    var now = 0;
    var timer = null;
...
function handleMenu() {
    ...
    var oHideBox = document.querySelector('.header-ad .hideBox');
    var oHidePhone = document.querySelector('.header-ad .hideBox .hidePhone');
    var timer = 0;
    for (var i = 0; i < aLi.length; i++){
        aLi[i].index = i;
